      ...
      <div className="footer-wrapper">
        ...
        <div className="footer-brand animate-slide-up">
          ...
          <p className="footer-desc">
            ...
            experiences. Turning ideas into scalable, elegant solutions.
          </p>
        ...
        {/* Quick Links */}
        <div
          className="footer-column animate-slide-up"
        ...
        >
          ...
          <ul>
            <li>
              <a href={resume} download="./Digvijay_Tripathy_Resume.pdf">
                <span className="link-arrow">→</span> Download CV
              </a>
            </li>
            <li>
              <a href="#testimonials">
                <span className="link-arrow">→</span> Testimonials
              </a>
            </li>
            <li>
              <a href="#blogs">
            ...
            <li>
              <a href="#experience">
                <span className="link-arrow">→</span> Experience
              </a>
            </li>
          </ul>
        </div>
